...
def abrir_ventana():
    ...
    funcion_label = tk.Label(window, text="Función:")
    funcion_label.pack()
    funcion_entry = tk.Entry(window)
    funcion_entry.pack()

    a_label = tk.Label(window, text="Punto de inicio a:")
    a_label.pack()
    a_entry = tk.Entry(window)
    a_entry.pack()

    b_label = tk.Label(window, text="Punto de inicio b:")
    b_label.pack()
    b_entry = tk.Entry(window)
    b_entry.pack()

    error_label = tk.Label(window, text="Porcentaje de error:")
    error_label.pack()
