...
def ventana1():
    ...
    miImagen=PhotoImage(file="D:\Programs\Prueba\Calcudora_Met_Alg\Calc_Met_Alg-V.3\logos/logo_completo.png")
    miImagen1=PhotoImage(file="D:\Programs\Prueba\Calcudora_Met_Alg\Calc_Met_Alg-V.3\logos/logo3.png")
...
def ventana2():
    ...
    root.geometry("650x400")
    root.resizable(False, False)
    miImagen1=PhotoImage(file="D:\Programs\Prueba\Calcudora_Met_Alg\Calc_Met_Alg-V.3\logos/logo_completo.png")
    miImagen2=PhotoImage(file="D:\Programs\Prueba\Calcudora_Met_Alg\Calc_Met_Alg-V.3\logos/logo3.png")
